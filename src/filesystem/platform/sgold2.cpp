...
void SGOLD2::load(bool skip_broken, bool skip_dup, std::vector<std::string> parts_to_extract) {
...
void SGOLD2::parse_FIT(bool skip_broken, bool skip_dup, std::vector<std::string> parts_to_extract) {
